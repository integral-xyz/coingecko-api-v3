...
describe('CoinGeckoClient test', () => {
    ...
    it('ping for pro API should also be successful', () => __awaiter(void 0, void 0, void 0, function* () {
        const proClient = new CoinGeckoClient_1.CoinGeckoClient({ apiKey: 'xxx' });
        const ping = (yield proClient.ping());
